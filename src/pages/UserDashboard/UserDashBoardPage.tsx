...
import { UserInforBar } from '../../components/DashBoard/Tasks/UserInforBar';
            ...
            <main className='flex min-h-screen min-w-screen bg-gray-800'>
                ...
                <div title='mainPage' className='h-screen w-full flex flex-col md:flex-row '>
                    <div title='statsAndCharts' className=' h-full w-full flex flex-col justify-center gap-8 bg-gray-900 p-8'>
                        <div title='rates' className='hidden md:block h-[10vh] flex flex-col scroll overlfow-y-scroll
                         justify-between justify-center gap-2 rounded-lg'>
                            <UserInforBar />
                        </div>

                        <div title='progress and forecast overview chart' className='flex bg-gray-800 h-[40vh] 
                        justify-center transition hover:scale-100 text-white rounded-lg scroll overflow-y-scroll'>
                            <ProgressCharts />
                        </div>

                        <div title='TasksInProgress' className='h-[40vh] flex flex-col text-white rounded-lg'>
                            <TasksInProgress />
                        </div>
                    </div>
                    <div title='UpcomingTasks' className=' hidden md:block md:h-screen min-w-screen md:w-1/5 scroll 
